...
- As the program reads in each word, it will output the words to the console (separated by a space).
- On a separate line, output the number of words that were found in the file.
